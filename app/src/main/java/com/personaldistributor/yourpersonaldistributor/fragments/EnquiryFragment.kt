...
import com.personaldistributor.yourpersonaldistributor.EnquiryRecyclerAdapter
...
class EnquiryFragment : Fragment() {
    ...
    lateinit var recyclerAdapter : EnquiryRecyclerAdapter
    ...
    override fun onCreateView(
        ...
        recyclerAdapter = EnquiryRecyclerAdapter(activity as Context,bookInfoList)
